...
export function HeroColumn({ title, content, icon }: Props) {
  let IconEl;
  ...
  return (
    <div className="hero__column">
      <div className="hero__column-icon">
        <IconEl />
      </div>
      <span className="hero__column-title">{title}</span>
      <div className="hero__column-content">{content}</div>
    </div>
  );
}
